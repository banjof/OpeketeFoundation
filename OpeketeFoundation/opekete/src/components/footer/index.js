                        ...
                        <div className="col col-lg-3 col-md-6 col-sm-12 col-12">
                            <div className="widget about-widget">
                                ...
                                <ul>
                                    ...
                                    <li><a onClick={ClickHandler} href="https://twitter.com/opeketefoundation" target="_blank"><i className="ti-twitter-alt"></i></a></li>
                                    <li><a onClick={ClickHandler} href="https://instagram.com/opeketefoundation" target="_blank"><i className="ti-instagram"></i></a></li>
