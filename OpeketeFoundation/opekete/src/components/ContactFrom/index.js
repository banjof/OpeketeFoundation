...
class ContactForm extends Component {
    ...
    subimtHandler = (e) => {
        ...
        if (error.name === '' && error.email === '' && error.email === '' && error.lastname === '' && error.subject === '' && error.events === '' && error.notes === ''&& error.message === '') {
            this.setState({
                name: '',
                email: '',
                subject: '',
    ...
    render(){
        ...
        return(
            <form  action="mailto:faladetimilehin@yahoo.com" method="get" enctype="text/plain" onSubmit={this.subimtHandler} className="form">
                <div className="row">
                    ...
                    <div className="col-lg-12">
                        <div className="form-field">
                            <textarea onChange={this.changeHandler} value={message} type="text" name="message" placeholder="Your Message Here"/>
